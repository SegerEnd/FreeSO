...
namespace FSO.Common.Utils
{
    public class PPXDepthEngine
    {
        ...
        public static void InitScreenTargets()
        {
            ...
            int scale = 1;//FSOEnvironment.DPIScaleFactor;
        ...
        {
            RenderTarget2D color = ActiveColor;
            RenderTarget2D depth = ActiveDepth;
            GraphicsDevice gd = GD;
            if (FSOEnvironment.SoftwareDepth && depth != null)
            {
                DepthStencilState oldDS = gd.DepthStencilState;
